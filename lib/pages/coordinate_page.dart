...
class CoordinatePage extends StatefulWidget {
  ...
  @override
  State<CoordinatePage> createState() => _CoordinatePage();
}

class _CoordinatePage extends State<CoordinatePage> {
            ...
            bottomNavigationBar: NavigationBar(
              ...
              destinations: <Widget>[
                NavigationDestination(
                  selectedIcon: SvgPicture.asset('assets/icons/coordinate.svg',
                      color: Colors.white),
                  icon: SvgPicture.asset('assets/icons/coordinate.svg'),
                  label: 'Koordinat',
                ),
                NavigationDestination(
